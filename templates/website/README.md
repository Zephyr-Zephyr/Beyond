...
style.css    CSS variables for colors/type + base styles
script.js    Small example script (mobile menu)
```

Colors and fonts live as CSS variables at the top of `style.css` and can
be adjusted centrally there.
